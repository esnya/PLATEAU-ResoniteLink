...
public sealed class DatasetInspectionServiceTests
{
    ...
    [Fact]
    public async Task GetStatsAsyncIgnoresMalformedPosListGeometryVramEstimate()
    {
        using TemporaryDirectory datasetRoot = new();
        WriteDatasetFile(
            datasetRoot.Path,
                    ...
                    <gml:MultiSurface>
                      <gml:surfaceMember>
                        <gml:Polygon>
                          <gml:exterior>
                            <gml:LinearRing>
                              <gml:posList>0 0 0 nope 0 0 0 1 0</gml:posList>
                            </gml:LinearRing>
                          </gml:exterior>
                        </gml:Polygon>
                      </gml:surfaceMember>
    ...
    [Fact]
    public async Task GetStatsAsyncIgnoresMalformedGmlPosFallbackGeometryVramEstimate()
    {
        using TemporaryDirectory datasetRoot = new();
        WriteDatasetFile(
            datasetRoot.Path,

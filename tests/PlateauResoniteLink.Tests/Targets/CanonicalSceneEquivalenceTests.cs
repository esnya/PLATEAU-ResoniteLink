...
public sealed class CanonicalSceneEquivalenceTests
{
        ...
        string[] packageNames)
    {
        ...
        Assert.Equal(
            string.Join(Environment.NewLine, GetExpectedSignature(scenarioName)),
    ...
    private static string[] GetExpectedSignature(string scenarioName)
    {
        return scenarioName switch
        {
            ...
            [
                ...
                "updates=0",
                "meshes=18:True:4/2:384:uv:18:16:4/3:1",
            ...
            [
                ...
                "updates=0",
                "meshes=12:True:2/2:9724675.71:uv:12:5:2/2:1|18:True:4/2:36168555.92:uv:18:16:6/5:1|6:False:2:-0:uv:6:6:2/2:1",
            ...
            [
                ...
                "updates=0",
                "meshes=6:False:2:-0:uv:6:6:2/2:1|78:True:4/22:139614:uv:78:78:13/8:1",

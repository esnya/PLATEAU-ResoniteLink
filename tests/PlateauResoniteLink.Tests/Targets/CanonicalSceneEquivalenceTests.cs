    ...
    private static string[] GetExpectedSignature(string scenarioName)
    {
        return scenarioName switch
        {
            ...
            [
                ...
                "updates=0",
                "meshes=12:True:2/2:9724675.714:9:1|18:True:4/2:36168555.922:-3220.391:1|6:False:2:-0:0:1",
            ...
            [
                ...
                "updates=0",
                "meshes=6:False:2:-0:0:1|78:True:4/22:139613.996:-106.515:1",

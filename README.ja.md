...
- `src/PlateauResoniteLink/Assets/DefaultMaterials/` 配下の bundled default material texture は source site ごとに分けています。AmbientCG asset の追跡メモは `THIRD_PARTY_LICENSES/ambientCG-CC0-1.0.txt`、TextureCan asset の追跡メモは `THIRD_PARTY_LICENSES/texturecan-CC0-1.0.txt` にあります。

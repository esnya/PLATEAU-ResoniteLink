...
{
    public static GeoReferencedRasterCropResult? TryCrop(
        ...
        GeographicRectangle requestedBounds)
    {
        ...
        return new GeoReferencedRasterCropResult(
            sourceImage.Clone(context => context.Crop(new Rectangle(left, top, right - left, bottom - top))),
            intersection);
    }
...
internal sealed record GeoReferencedRasterCropResult(
    Image<Rgba32> Image,

        ...
        Action<string>? progressReporter)
    {
        ...
        return new ResoniteLiveSceneImportTarget(
            ...
            new ResoniteLiveSceneImportSession(
                ...
                diagnostics),
            new ResoniteLiveSceneImportExecutionServices(
                serviceProvider.GetRequiredService<IResoniteLiveSendExecutionGateFactory>().Create(),
                serviceProvider.GetRequiredService<IResoniteLiveSendRunStarter>(),
                serviceProvider.GetRequiredService<IResoniteImportedObjectUnitStreamQueueWriter>(),
                serviceProvider.GetRequiredService<IResoniteLiveSendRunFinalizer>(),
                serviceProvider.GetRequiredService<IResoniteLiveSendExecutionResultFactory>(),
                serviceProvider.GetRequiredService<IResoniteLiveSendRunResourceReleaser>(),
                serviceProvider.GetRequiredService<IResoniteQueuedCityObjectSenderFactory>()
                    .Create(new DeterministicTerrainTextureAssetGenerator())));
    }
}

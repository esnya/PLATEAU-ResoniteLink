...
internal interface IResoniteSharedTerrainTextureAssetStore
{
...
internal sealed class ResoniteSharedTerrainTextureAssetStore : IResoniteSharedTerrainTextureAssetStore
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        CreatedSlot meshSlot = await state.Placement.GetOrCreateSharedChildSlotAsync(
            ...
            meshCode,
            cancellationToken);
        SharedTerrainTextureAsset? existingTexture = await TryFindAsync(
            importClient,
            meshSlot,
            cancellationToken);
    ...
    private static async Task<SharedTerrainTextureAsset?> TryFindAsync(
        IResoniteLinkClient importClient,

    ...
    Func<IResoniteLinkClient, ResoniteSlotLocator, string, ResoniteFloat3?, ResoniteFloatQ?, CancellationToken, Task<CreatedSlot>> createSlotAsync)
{
    ...
    private ObservedSourceRootPlacementResolver? observedSourceRootPlacementResolver;
    ...
    {
        observedSourceRootPlacementResolver ??= new ObservedSourceRootPlacementResolver(
            datasetRootSlot.Locator,
            observedSlotSnapshotsById,
            createdSlotIds);
        observedSourceRootPlacementResolver.Reset();
    ...
    private SourceRootPlacement ResolveSourceRootPlacement(
        ...
        string rootMeshCode)
    {
        ResoniteFloat3? observedRootPosition = observedSourceRootPlacementResolver?.TryResolve(sourceFileSlotName, rootMeshCode);
        ResoniteFloat3 rootPosition = observedRootPosition

...
internal interface IResonitePreparedTextureReferenceFactory
{
    Task<PreparedTextureReference[]> CreateAsync(
...
internal sealed class ResonitePreparedTextureReferenceFactory(
    ITerrainTextureAssetGenerator terrainTextureAssetGenerator,
    IResoniteDatasetLicenseWriter datasetLicenseWriter) : IResonitePreparedTextureReferenceFactory
{
    ...
    public async Task<PreparedTextureReference[]> CreateAsync(
        LiveSendRunState state,
        IResoniteLinkClient routedClient,
        ResoniteConstructionCityObject cityObject,
        Action<string>? progressReporter,
        CancellationToken cancellationToken)
    {
        ...
        (string TerrainMeshCode, TerrainTextureOverlay TerrainOverlay)[] distinctTerrainOverlays = cityObject.Materials
            ...
            .Select(entry => (
                TerrainMeshCode: ResoniteTerrainTextureMaterialContract.ValidateMeshCode(
                    cityObject,
                    entry.MaterialIndex,
                    entry.Material,

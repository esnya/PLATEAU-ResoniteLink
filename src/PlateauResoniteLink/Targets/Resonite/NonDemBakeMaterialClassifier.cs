...
internal static class NonDemBakeMaterialClassifier
{
    ...
    internal static bool IsAtlasBakeCandidate(ResoniteMaterialBinding material)
    {
    ...
    internal static NonDemMaterialBakeCategory ClassifyMaterial(ResoniteMaterialBinding material)
    {

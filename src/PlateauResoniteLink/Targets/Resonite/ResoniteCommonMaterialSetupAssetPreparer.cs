...
internal interface IResoniteCommonMaterialSetupAssetPreparer
{
    Task PrepareAsync(
...
internal sealed class ResoniteCommonMaterialSetupAssetPreparer(
    IResoniteMaterialPlanning materialPlanning) : IResoniteCommonMaterialSetupAssetPreparer
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            reportProgress?.Invoke(PlateauLog.Info("live", "No common material assets are required during scene setup."));
            return;
        }
    ...
    private static void SeedSetupCommonMaterialAssets(
        ResoniteSceneSetupState setupState,
        CommonMaterialAssetCache materials,
        LiveSendProgressSink progress,
        Action<string>? reportProgress)
    {
        ...
        {
            reportProgress?.Invoke(PlateauLog.Info("live", "Setup created common material slots; no textureless common material components were needed in setup batch."));
        }
    }

...
internal sealed class LiveSendRunState
{
    ...
    public required Dictionary<string, LodGroupRenderers> LodGroupRenderersBySourceFileSlotId { get; init; }
}

internal sealed class LodGroupRenderers
{
    public required CreatedSlot SourceFileSlot { get; init; }

    public Dictionary<DetailLevel, SortedDictionary<string, ResoniteComponentLocator>> RenderersByDetailLevel { get; } = new();
}

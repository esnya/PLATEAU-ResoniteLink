...
internal sealed record RoadSurfaceEdgeSelection(
    GeodeticPoint[] Side0,
    GeodeticPoint[] Side1,
...
internal static class RoadSurfaceEdgeSelector
{
    public static RoadSurfaceEdgeSelection SelectPrimary(
    ...
    public static RoadSurfaceEdgeSelection SelectPrimary(
        ...
        Float3[] positions)
    {
        RoadSurfaceEdgeSelection pair = SelectPrimary(ring.Vertices, positions);

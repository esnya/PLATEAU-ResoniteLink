...
internal static class TerrainAlignedTransportationSurfaceSubdivider
{
    public const double DefaultSegmentLengthMeters = 5.0;
    public const double MinSegmentLengthMeters = 2.0;
    public const double SegmentLengthByWidthRatio = 0.8;

    public static ParsedSurface[] Subdivide(ParsedCityObject cityObject)
    {
        ...
        {
            subdividedSurfaces.AddRange(Subdivide(surface, cityObject));
        }

        return subdividedSurfaces.ToArray();
    }

    private static List<ParsedSurface> Subdivide(
        ...
        ParsedCityObject cityObject)
    {
        ...
        RoadSurfaceEdgeSelection edgePair = RoadSurfaceEdgeSelector.SelectPrimary(surface.ExteriorRing, positions);
    ...
    private static List<ParsedSurface> CreateStrips(
        ParsedSurface surface,
        Float3[] positions,
        RoadSurfaceEdgeSelection edgePair,
        double segmentLength)
    {
        Float3 axis = CreateSurfaceAxis(edgePair);
    ...
    private static Float3 CreateSurfaceAxis(RoadSurfaceEdgeSelection edgePair)
    {
